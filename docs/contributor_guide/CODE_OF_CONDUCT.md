# Code of conduct for `example_rep`

Contributors to this repository hosted by `DataS-DHSC` are expected to follow the
...
- "Project", we mean this `example_rep` GitHub repository;
- "Maintainer", we mean the `DataS-DHSC` organisation owners; and
- "Leadership", we mean both `DataS-DHSC` organisation owners, line managers, and other
  leadership within the DHSC.
